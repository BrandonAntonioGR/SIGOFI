...
public class modificaRecibidos extends javax.swing.JFrame {
    CoOpciones co= new CoOpciones();
    PreparedStatement ps;
    ResultSet rs;
    int filaSeleccionada;
    
    public modificaRecibidos(int id) {
        initComponents();
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        try {
            ...
            Logger.getLogger(modificaRecibidos.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
