...
public class ControladorCargaEnviadosFiltroFechOficio implements ActionListener, TableModelListener{
    ...
    public ControladorCargaEnviadosFiltroFechOficio(VistaEnviados tbl,Date fech_Oficio) throws SQLException{
        this.tblEnv = tbl;
        model = new ModelQuerysEnviados();
        ProveedorDatosPaginacion<Enviado> proveedorDeDatosPaginacion =crearProveedorDeDatos(fech_Oficio);
    ...
    private ProveedorDatosPaginacion<Enviado> crearProveedorDeDatos(Date fech_Oficio) throws SQLException{
        List<Enviado> lista = ModelQuerysFiltroEnviados.filtrarFechaOficio(fech_Oficio);
