...
public class ControladorCargaEnviadosFiltroNumOfiicio implements ActionListener, TableModelListener{
    ...
    public ControladorCargaEnviadosFiltroNumOfiicio(VistaEnviados tbl,String num_Oficio) throws SQLException{
        this.tblEnv = tbl;
        model = new ModelQuerysEnviados();
        ProveedorDatosPaginacion<Enviado> proveedorDeDatosPaginacion =crearProveedorDeDatos(num_Oficio);
    ...
    private ProveedorDatosPaginacion<Enviado> crearProveedorDeDatos(String num_Oficio) throws SQLException{
        List<Enviado> lista = ModelQuerysFiltroEnviados.filtrarNumeroOficio(num_Oficio);
