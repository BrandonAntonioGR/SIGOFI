...
public class ControladorCargaEnviadosFiltroComentarios implements ActionListener, TableModelListener{
    ...
    public ControladorCargaEnviadosFiltroComentarios(VistaEnviados tbl,String comentarios) throws SQLException{
        this.tblEnv = tbl;
        model = new ModelQuerysEnviados();
        ProveedorDatosPaginacion<Enviado> proveedorDeDatosPaginacion =crearProveedorDeDatos(comentarios);
    ...
    private ProveedorDatosPaginacion<Enviado> crearProveedorDeDatos(String comentarios) throws SQLException{
        List<Enviado> lista = ModelQuerysFiltroEnviados.filtraComentarios(comentarios);
